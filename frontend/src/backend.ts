...
import type { SpendingLimit as _SpendingLimit, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addDigiPoints(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addDigiPoints(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async completeChallenge(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createChallenge(arg0: string, arg1: number, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createChallenge(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerBalance(): Promise<number> {
        if (this.processError) {
            try {
    ...
    async getDigiPoints(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getDigiPoints();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReferralPoints(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getReferralPoints();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReferrals(): Promise<Array<Principal>> {
        if (this.processError) {
            try {
    ...
    async getTransactions(arg0: string | null): Promise<Array<Transaction>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTransactions(to_candid_opt_n16(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasPinSet(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasPinSet();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async referUser(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.referUser(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setBankAccount(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setBankAccount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setSpendingLimit(arg0: string, arg1: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setSpendingLimit(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storePinHash(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storePinHash(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBalance(arg0: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async verifyPinHash(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyPinHash(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    balance: number;
    name: string;
    spendingLimits: Array<_SpendingLimit>;
    digiPoints: bigint;
}): {
    bankAccountNumber?: string;
    balance: number;
    ...
    return {
        bankAccountNumber: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.bankAccountNumber)),
        balance: value.balance,
        name: value.name,
        spendingLimits: value.spendingLimits,
        digiPoints: value.digiPoints
    };
}
